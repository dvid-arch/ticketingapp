    ...
    return (
        <div className="w-full  flex flex-col gap-8 " >
            ...
            <div className='flex flex-col gap-6 justify-center items-center'>
                ...
                <div className='text-center py-8 px-[21px] relative w-fit' >
                ...
                <div className="border rounded-[24px] w-full px-12 border-[#0E464F] flex justify-center gap-8">
                    <button className="rounded-[8px] capitalize block w-full py-3 px-6 border border-[#2BA4B9] bg-[#041E23] text-white">
                        Book Another Ticket
                    </button>
                    <button className="rounded-[8px] capitalize block w-full py-3 px-6 bg-[#2BA4B9] border border-[#2BA4B9] text-white">
                        Download Ticket
                    </button>
                </div>
