...
function Ready({handleBookAnother}) {
    ...
    function handledBookAnother(){
        console.log('booking anotherw')
    }
        ...
        <div className="bg-[#041E23]  p-12 rounded-[40px] flex flex-col gap-8 mx-auto w-full max-w-[700px]">
            <div className="flex flex-col gap-3 ">
                ...
                <div className="flex justify-between gap-3 items-center">
                    <h1 className="font-serif text-[32px] text-white">Ready</h1>
                    <span className="text-white ">Step <span>{3}</span>/<span>3</span></span>
                </div>
